...
export function createOptionsView(props: Readonly<OptionsViewProps>): DocumentFragment {
    ...
    const fragment = createDocFragmentTree([
        element('div', null, [
            element('h2', null, [text('Build Information')]),
            element('table', null, [
                element('tr', null, [
                    element('th', null, [text('GIT_REVISION')]),
                    element('td', null, [text(GIT_REVISION)]),
                ]),
                element('tr', null, [
                    element('th', null, [text('BUILD_DATE')]),
                    element('td', null, [text(BUILD_DATE)]),
                ]),
                element('tr', null, [
                    element('th', null, [text('RELEASE_CHANNEL')]),
                    element('td', null, [text(RELEASE_CHANNEL)]),
                ]),
            ]),
        ]),
        element('div', null, [element('h2', null, [text('for debug')]), element('ul', null, links)]),
    ]);
