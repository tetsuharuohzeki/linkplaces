        ...
        <div>
            <PanelSectionList>
                <PanelListItem onClick={onClickOpenWebExtSidebar}>
                    <PanelListItemIcon>
                        <popup-item-icon src={'../shared/image/icon/context-fill/sidebar-16.svg'} />
                    </PanelListItemIcon>
                    <PanelListItemText>
    ...
    return (
        ...
        >
            <PanelListItem onClick={onClick}>
                <PanelListItemIcon>
                    <popup-item-icon src={'../shared/image/icon/context-fill/folder-16.svg'} />
                </PanelListItemIcon>
                <PanelListItemText>
                    {item.title}
                </PanelListItemText>
    ...
    return (
        <React.StrictMode>
            ...
            >
                <PanelListItem>
                    <PanelListItemIcon>
                        <popup-item-icon src={'../shared/image/icon/context-fill/globe-16.svg'} />
                    </PanelListItemIcon>
                    <PanelListItemText>
                        {label}
                    </PanelListItemText>
